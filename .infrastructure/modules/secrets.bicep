...
output storageAccountConnectionStringSecretUri string = storageAccountConnectionStringSecret.properties.secretUri
output eventHubSendAccessPolicySecretUri string = eventHubSendAccessPolicySecret.properties.secretUri
output eventHubListenAccessPolicySecretUri string = eventHubListenAccessPolicySecret.properties.secretUri
